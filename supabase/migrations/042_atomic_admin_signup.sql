-- ============================================================
-- 042: Atomic admin signup with bumping
-- Extends safe_signup_for_sheet() to handle high-priority
-- (admin) signups atomically, including bumping the lowest-
-- priority confirmed player when the sheet is full.
--
-- All signups now go through this single RPC, eliminating
-- race conditions for both normal and admin signups.
-- ============================================================
...
BEGIN
  ...
  ELSIF p_priority = 'high' THEN
    -- Sheet is full and this is a high-priority (admin) signup.
