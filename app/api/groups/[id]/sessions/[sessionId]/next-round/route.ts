...
export async function POST(
  ...
  // Group-level score validation: every match in this round has to
  // satisfy the game limit and (optional) win-by-2 rule before we
  // persist anything. Mirrors the standalone /free-play POST so a
  // session-end never ingests obviously invalid finishes.
